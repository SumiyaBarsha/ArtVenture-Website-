...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section>
        ...
        <div style="margin-top:30px;margin-bottom:30px;display: grid;grid-template-columns: 1fr 1fr">
            ...
            <div><p style="font-size: 36px;text-decoration: underline;">Image Description</p>
                <div class="desc">Price:$12,000</div>
                <div class="desc">Medium:Oil</div>
                <div class="desc">Frame Size:32"X24"</div>
                <div>Description:<br>100% hand-painted original flower oil painting, red cherry blossoms in full bloom on canvas, large mountain abstract painting party, clear lake, lake reflection, fashionable wall decorative artwork, handmade home decor, original hand-painted texture canvas mural,
                     accept custom photo oil painting, Christmas gift, New Year gift, housewarming gift.</div>
                     <div><button class="follow-btn" style="margin-top: 10px;margin-left: 0;">Add to Cart</button>
