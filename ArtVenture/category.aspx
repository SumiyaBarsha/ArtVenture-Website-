...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div
        style="padding:20px;display:grid;grid-template-columns: 1fr 4.5fr 0.5fr 0.5fr 0.5fr 0.5fr 0.5fr;background-image:url(img/artsy\ \(2\).jfif)">
    ...
    <section>
        ...
        <div style="margin-top:30px;margin-bottom:30px;display: grid;grid-template-columns: 1fr 1fr 1fr 1fr">
            <div>
                <div class="paint"><a href="PicDetail.aspx"><img src="img/painting1.avif" style="margin-left: 30px;height:175px;width:210px"></a></div>
                <div>
                    <div>
